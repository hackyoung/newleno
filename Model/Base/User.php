...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setRemoved($v)
    {
        ...
        if ($this->removed !== null || $dt !== null) {
            if ($this->removed === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->removed->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[UserTableMap::COL_REMOVED] = true;
            }
        } // if either are not null
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_REMOVED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_REMOVED)) {
            $criteria->add(UserTableMap::COL_REMOVED, $this->removed);
        }
     ...
     * @return ObjectCollection|ChildTask[] List of ChildTask objects
     */
    public function getTasksJoinCategory(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTaskQuery::create(null, $criteria);
     ...
     * @return ObjectCollection|ChildOrder[] List of ChildOrder objects
     */
    public function getOrdersJoinTask(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOrderQuery::create(null, $criteria);
