...
abstract class Category implements ActiveRecordInterface
{
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[CategoryTableMap::COL_LABEL] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->created->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[CategoryTableMap::COL_CREATED] = true;
            }
    ...
    public function setUpdated($v)
    {
        ...
        if ($this->updated !== null || $dt !== null) {
            if ($this->updated === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->updated->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[CategoryTableMap::COL_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function setRemoved($v)
    {
        ...
        if ($this->removed !== null || $dt !== null) {
            if ($this->removed === null || $dt === null || $dt->format("Y-m-d H:i:s") !== $this->removed->format("Y-m-d H:i:s")) {
                ...
                $this->modifiedColumns[CategoryTableMap::COL_REMOVED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategoryTableMap::translateFieldName('Label', TableMap::TYPE_PHPNAME, $indexType)];
            $this->label = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoryTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CategoryTableMap::translateFieldName('Updated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->updated = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CategoryTableMap::translateFieldName('Removed', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_LABEL)) {
            $modifiedColumns[':p' . $index++]  = 'label';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_CREATED)) {
            $modifiedColumns[':p' . $index++]  = 'created';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = 'updated';
        }
        if ($this->isColumnModified(CategoryTableMap::COL_REMOVED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_LABEL)) {
            $criteria->add(CategoryTableMap::COL_LABEL, $this->label);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_CREATED)) {
            $criteria->add(CategoryTableMap::COL_CREATED, $this->created);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_UPDATED)) {
            $criteria->add(CategoryTableMap::COL_UPDATED, $this->updated);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_REMOVED)) {
            $criteria->add(CategoryTableMap::COL_REMOVED, $this->removed);
        }
    ...
    public function initTasks($overrideExisting = true)
    {
        ...
        $this->collTasks->setModel('\Model\Task');
    }
