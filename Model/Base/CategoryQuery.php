 ...
 * @method     ChildCategoryQuery orderByLabel($order = Criteria::ASC) Order by the label column
 * @method     ChildCategoryQuery orderByCreated($order = Criteria::ASC) Order by the created column
 * @method     ChildCategoryQuery orderByUpdated($order = Criteria::ASC) Order by the updated column
 * @method     ChildCategoryQuery orderByRemoved($order = Criteria::ASC) Order by the removed column
 ...
 * @method     ChildCategoryQuery groupByLabel() Group by the label column
 * @method     ChildCategoryQuery groupByCreated() Group by the created column
 * @method     ChildCategoryQuery groupByUpdated() Group by the updated column
 * @method     ChildCategoryQuery groupByRemoved() Group by the removed column
 ...
 *
 * @method     \Model\TaskQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildCategory findOneByLabel(string $label) Return the first ChildCategory filtered by the label column
 * @method     ChildCategory findOneByCreated(string $created) Return the first ChildCategory filtered by the created column
 * @method     ChildCategory findOneByUpdated(string $updated) Return the first ChildCategory filtered by the updated column
 * @method     ChildCategory findOneByRemoved(string $removed) Return the first ChildCategory filtered by the removed column
 ...
 * @method     ChildCategory requireOneByLabel(string $label) Return the first ChildCategory filtered by the label column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCategory requireOneByCreated(string $created) Return the first ChildCategory filtered by the created column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCategory requireOneByUpdated(string $updated) Return the first ChildCategory filtered by the updated column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCategory requireOneByRemoved(string $removed) Return the first ChildCategory filtered by the removed column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildCategory[]|ObjectCollection findByLabel(string $label) Return ChildCategory objects filtered by the label column
 * @method     ChildCategory[]|ObjectCollection findByCreated(string $created) Return ChildCategory objects filtered by the created column
 * @method     ChildCategory[]|ObjectCollection findByUpdated(string $updated) Return ChildCategory objects filtered by the updated column
 * @method     ChildCategory[]|ObjectCollection findByRemoved(string $removed) Return ChildCategory objects filtered by the removed column
...
abstract class CategoryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'leno', $modelName = '\\Model\\Category', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, label, created, updated, removed, created_at, updated_at FROM category WHERE id = :p0';
        try {
    ...
    public function filterByLabel($label = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_LABEL, $label, $comparison);
    }
    ...
    public function filterByCreated($created = null, $comparison = null)
    {
        if (is_array($created)) {
            ...
            if (isset($created['min'])) {
                $this->addUsingAlias(CategoryTableMap::COL_CREATED, $created['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($created['max'])) {
                $this->addUsingAlias(CategoryTableMap::COL_CREATED, $created['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_CREATED, $created, $comparison);
    }
    ...
    public function filterByUpdated($updated = null, $comparison = null)
    {
        if (is_array($updated)) {
            ...
            if (isset($updated['min'])) {
                $this->addUsingAlias(CategoryTableMap::COL_UPDATED, $updated['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updated['max'])) {
                $this->addUsingAlias(CategoryTableMap::COL_UPDATED, $updated['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_UPDATED, $updated, $comparison);
    }
    ...
    public function filterByRemoved($removed = null, $comparison = null)
    {
        if (is_array($removed)) {
            ...
            if (isset($removed['min'])) {
                $this->addUsingAlias(CategoryTableMap::COL_REMOVED, $removed['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($removed['max'])) {
                $this->addUsingAlias(CategoryTableMap::COL_REMOVED, $removed['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_REMOVED, $removed, $comparison);
    }
     ...
     *
     * @param \Model\Task|ObjectCollection $task the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByTask($task, $comparison = null)
    {
        if ($task instanceof \Model\Task) {
            return $this
                ->addUsingAlias(CategoryTableMap::COL_ID, $task->getCatId(), $comparison);
