...
class TechTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.TechTableMap';
     ...
     */
    const COL_TECH_ID = 'tech.tech_id';
     ...
     */
    const COL_DELETED = 'tech.deleted';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('TechId', 'Label', 'Description', 'Url', 'Hot', 'Created', 'Updated', 'Deleted', ),
        self::TYPE_CAMELNAME     => array('techId', 'label', 'description', 'url', 'hot', 'created', 'updated', 'deleted', ),
        self::TYPE_COLNAME       => array(TechTableMap::COL_TECH_ID, TechTableMap::COL_LABEL, TechTableMap::COL_DESCRIPTION, TechTableMap::COL_URL, TechTableMap::COL_HOT, TechTableMap::COL_CREATED, TechTableMap::COL_UPDATED, TechTableMap::COL_DELETED, ),
        self::TYPE_FIELDNAME     => array('tech_id', 'label', 'description', 'url', 'hot', 'created', 'updated', 'deleted', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('TechId' => 0, 'Label' => 1, 'Description' => 2, 'Url' => 3, 'Hot' => 4, 'Created' => 5, 'Updated' => 6, 'Deleted' => 7, ),
        self::TYPE_CAMELNAME     => array('techId' => 0, 'label' => 1, 'description' => 2, 'url' => 3, 'hot' => 4, 'created' => 5, 'updated' => 6, 'deleted' => 7, ),
        self::TYPE_COLNAME       => array(TechTableMap::COL_TECH_ID => 0, TechTableMap::COL_LABEL => 1, TechTableMap::COL_DESCRIPTION => 2, TechTableMap::COL_URL => 3, TechTableMap::COL_HOT => 4, TechTableMap::COL_CREATED => 5, TechTableMap::COL_UPDATED => 6, TechTableMap::COL_DELETED => 7, ),
        self::TYPE_FIELDNAME     => array('tech_id' => 0, 'label' => 1, 'description' => 2, 'url' => 3, 'hot' => 4, 'created' => 5, 'updated' => 6, 'deleted' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Tech');
        $this->setPackage('');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('tech_id', 'TechId', 'INTEGER', true, null, null);
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TechId', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TechId', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TechId', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TechId', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TechId', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('TechId', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TechTableMap::COL_TECH_ID);
            ...
            $criteria->addSelectColumn(TechTableMap::COL_DELETED);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tech) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(TechTableMap::DATABASE_NAME);
            $criteria->add(TechTableMap::COL_TECH_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(TechTableMap::COL_TECH_ID) && $criteria->keyContainsValue(TechTableMap::COL_TECH_ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.TechTableMap::COL_TECH_ID.')');
        }
