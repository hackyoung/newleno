...
class UserTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('UserId', 'Email', 'Name', 'Age', 'Password', ),
        self::TYPE_CAMELNAME     => array('userId', 'email', 'name', 'age', 'password', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID, UserTableMap::COL_EMAIL, UserTableMap::COL_NAME, UserTableMap::COL_AGE, UserTableMap::COL_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('user_id', 'email', 'name', 'age', 'password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('UserId' => 0, 'Email' => 1, 'Name' => 2, 'Age' => 3, 'Password' => 4, ),
        self::TYPE_CAMELNAME     => array('userId' => 0, 'email' => 1, 'name' => 2, 'age' => 3, 'password' => 4, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID => 0, UserTableMap::COL_EMAIL => 1, UserTableMap::COL_NAME => 2, UserTableMap::COL_AGE => 3, UserTableMap::COL_PASSWORD => 4, ),
        self::TYPE_FIELDNAME     => array('user_id' => 0, 'email' => 1, 'name' => 2, 'age' => 3, 'password' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
