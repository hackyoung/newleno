...
*/
abstract class Cate implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CateTableMap';
    ...
    /**
     * Initializes internal state of Base\Cate object.
     */
    ...
    /**
     * Compares this with another <code>Cate</code> instance.  If
     * <code>obj</code> is an instance of <code>Cate</code>, delegates to
     * <code>equals(Cate)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Cate The current object, for fluid interface
     */
     ...
     * @return $this|\Cate The current object (for fluent API support)
     */
    public function setCatId($v)
    {
        ...
        if ($this->cat_id !== $v) {
            $this->cat_id = $v;
            $this->modifiedColumns[CateTableMap::COL_CAT_ID] = true;
        }
    ...
    public function setLabel($v)
    {
        ...
        if ($this->label !== $v) {
            $this->label = $v;
            $this->modifiedColumns[CateTableMap::COL_LABEL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CateTableMap::translateFieldName('CatId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cat_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CateTableMap::translateFieldName('Label', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = CateTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Cate'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCateQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCateQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CateTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CateTableMap::COL_CAT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'cat_id';
        }
        if ($this->isColumnModified(CateTableMap::COL_LABEL)) {
    ...
    {
        $pos = CateTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Cate'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Cate'][$this->hashCode()] = true;
        $keys = CateTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CateTableMap::COL_CAT_ID)) {
            $criteria->add(CateTableMap::COL_CAT_ID, $this->cat_id);
        }
        if ($this->isColumnModified(CateTableMap::COL_LABEL)) {
            $criteria->add(CateTableMap::COL_LABEL, $this->label);
        }
    ...
    {
        $criteria = ChildCateQuery::create();
        $criteria->add(CateTableMap::COL_CAT_ID, $this->cat_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Cate (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Cate Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCate is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCate The current object (for fluent API support)
     */
     ...
     * Otherwise if this Cate is new, it will return
     * an empty collection; or if this Cate has previously
     * been saved, it will retrieve related Tasks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Cate.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildTask[] List of ChildTask objects
     */
    public function getTasksJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildTaskQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(CateTableMap::DEFAULT_STRING_FORMAT);
    }
